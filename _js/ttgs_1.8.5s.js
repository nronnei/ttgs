...
['New Park Entrance', '0', '0', 'None', '7/14/2015'],
['Newer Park Entrance', '0', '10', 'None', '']
],
                entranceMarkerArray = [],
                entranceIBs = [],
                infoMarkerArray = [],
                ...
                entranceSetup = function () {
                    var entranceMarker = function(i) {
                        var siteLatLng = new google.maps.LatLng(ent[1], ent[2]);
                        var icon = {
            ...
            this.init = function() {
                _init();
                return this; // Refers to: ttgs.Directions
            };
            return this.init(); // Refers to: ttgs.Directions.init()
        } // _Directions Ends
        return new _Directions(); // Creating a new object of _Directions rather than a function
    }()); // ttgs.Directions Ends
})(window.ttgs = window.ttgs || {}, jQuery);
