...
(function(mapObj, $){
    mapObj.PlaceMarkers = (function() {
        function _Map () {
            var map, directionService, directionDisplay,geocodeService,
                userLocation, userMarkerImage, userMarker, destLocation,
            // Define all arrays
            parkInfo = [
            ...
            infoSetup = function () {
                for (var i = 0; i < parkInfo.length; i++) {
                    ...
                    var parkMarker = function(){
                        ...
                        infoMarkerArray.push(parkMarker);
                    }
            },
            ...
            this.init = function() {
                _init();
                return this; // Refers to: mapDemo.PlaceMarkers
            };
            return this.init(); // Refers to: mapDemo.PlaceMarkers.init()
        } // _Directions Ends
        return new _Map(); // Creating a new object of _Map rather than a function
    }()); // mapDemo.PlaceMarkers Ends
})(window.mapObj = window.mapObj || {}, jQuery);